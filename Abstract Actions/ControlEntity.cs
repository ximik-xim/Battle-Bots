...
public class ControlEntity : MonoBehaviour
{
  [SerializeField]  private AbstractAttack _attack;
   ...
   public void SearchEnemy(float range, Action<Entity> detectEntity)
    ...
    public void AttackTarget(Entity target,float distanceAttack,float damage,Action<bool> endAttack,Action killEntity)
    {
        _attack.Attack(target,distanceAttack,damage,endAttack,killEntity);
    }
